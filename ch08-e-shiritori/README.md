...
| ファイル | 役割 |
|---|---|
| `app.py` | Chainlit UI レイヤー |
| `gemini.py` | Gemini API レイヤー |
| `public/elements/DrawCanvas.jsx` | お絵かきキャンバス（CustomElement） |
| `public/stylesheet.css` | UI カスタマイズ用 CSS |
| `public/autoscroll.js` | 自動スクロール JS |
